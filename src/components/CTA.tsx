      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 border border-white/20">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join CalmChase programs and develop essential life skills, build self-confidence, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="text-white/90">
              <div className="text-2xl font-bold mb-1">✓ Expert Mentors</div>
              <div className="text-sm">Guidance from experienced professionals</div>
            </div>
            <div className="text-white/90">
              <div className="text-2xl font-bold mb-1">✓ Proven Results</div>
              <div className="text-sm">Success stories that inspire</div>
            </div>
            <div className="text-white/90">
              <div className="text-2xl font-bold mb-1">✓ Community Support</div>
              <div className="text-sm">Join our thriving community</div>
            </div>
          </div>
        </div>
      </div>
