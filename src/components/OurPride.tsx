...
const OurPride = () => {
  ...
  return (
    <section className="py-20 overflow-hidden relative bg-gradient-to-br from-indigo-900 to-purple-800">
        ...
        >
          {achievements.map((achievement, index) => (
            ...
            >
              ...
              <div className="relative bg-black/40 backdrop-blur-sm rounded-xl p-8 text-center border border-white/20 h-full flex flex-col items-center justify-center">
              ...
              >
                ...
                <div className="relative bg-black/30 backdrop-blur-md rounded-xl p-6 border border-white/20 h-full">
                  <div className="flex items-center mb-6">
                    <div className="w-14 h-14 rounded-full overflow-hidden border-2 border-white/50 mr-4 shadow-xl">
                      <img 
